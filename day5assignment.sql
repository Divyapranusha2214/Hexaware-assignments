...
name varchar(20),branchid int,
gender varchar(20),
branch varchar(20))
insert into student values('div',1,'female','cse'),('pranu',2,'female','ece'),('lilly',3,'female','mech'),
('divya',2,'female','it'),('pranusha',3,'male','eee')
select *from student
drop table student
--info by branchid
...
insert into tablemplyee values(1,'mark','male',9000,1),
(2,'ark','male',91000,3),(3,'maozrk','male',19000,2),
(4,'markini','female',29000,1),(5,'marks','female',9000,3)
